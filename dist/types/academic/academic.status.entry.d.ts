 ...
 */
export interface AcademicStatusEntry extends Omit<StudentCourse, "estado" | "estadoMateria" | "faltaAprobar" | "faltaReg" | "nota" | "anioCursado"> {
    /**
    ...
    estadoMateria: "NO_CURSADA" | "APROBADA" | "REGULARIZADA" | "LIBRE" | "CURSANDO";
